...
class StackingEnsemble:
    ...
    def fit(self, X_train, y_train, X_val, y_val, config):
        ...
        stacked_input_val = np.hstack(
            weighted_preds
        )  # shape: (n_val_samples, n_models * n_features * n_future)
    ...
    def predict(self, X_test):
        ...
        n_future_steps = self.base_models[0].output_shape[
            1
        ]  # assumes all models have same output shape
